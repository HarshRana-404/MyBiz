    ...
    override fun onCreateView(
        ...
        try {
                ...
                override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                    ...
                    if (!productSearch.isEmpty()) {
                        try {
                            ...
                            productsAdapter =
                                ProductAdapter(fragProducts.context, alSearchResultProducts)
                            rvProducts.adapter = productsAdapter
                        ...
                        productsAdapter =
                            ProductAdapter(fragProducts.context, Constants.alProductsOptimized)
                        rvProducts.adapter = productsAdapter
                        productsAdapter.notifyDataSetChanged()
                    }
                }
            ...
            fabAddProduct.setOnClickListener(View.OnClickListener {
                ...
                bsAddProductView = LayoutInflater.from(fragProducts.context)
                    .inflate(R.layout.bottom_sheet_add_product, null, false)
                    ...
                    if (!productName.isEmpty() && !productPrice.isEmpty()) {
                        ...
                        if (!alreadyExists) {
                            try {
                                hmProduct.put(
                                    "id",
                                    Constants.getUUIDForText(productName.toLowerCase().toString())
                                )
